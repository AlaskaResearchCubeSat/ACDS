...
#define __ACDS_H
  ...
  enum{ACDS_EVT_DAT_REC=BIT0,ADCS_EVT_CAL_COMPLETE=BIT1,ADCS_EVT_COMMAND_SENSOR_READ=BIT2,ACDS_EVT_DAT_TIMEOUT=BIT3,
      ACDS_EVT_SEND_DAT=BIT3,ACDS_EVT_WRITE_GAIN=BIT4,ACDS_EVT_WRITE_SETPOINT=BIT5};

  //all events for ACDS
  #define ACDS_EVT_ALL  (ACDS_EVT_DAT_REC|ACDS_EVT_DAT_TIMEOUT|ACDS_EVT_SEND_DAT|ACDS_EVT_WRITE_GAIN|ACDS_EVT_WRITE_SETPOINT)
